...
class RknnThreadPool():
    ...
    def put(self, frame, id = -1, full_frame = None):
        if id < 0 or id >= self.num_model:
            ...
            index = id
        self.queue.put(self.pool.submit(self.func, self.rknnPool[index], frame, id, full_frame))
        self.num += 1
...
if __name__ == '__main__':
    ...
    rknnThreadPool.startThreads('./model/yolov8n.rknn', 3, postprocess.detect_frame)
