...
def setup_model(args):
    ...
    platform = 'onnx'
    model = ONNX_model_container_py(args.model_path)
...
if __name__ == '__main__':
    ...
    # basic params
    parser.add_argument('--model_path', type=str, default='../model/yolov8n.onnx', help='model path, could be .pt or .rknn file')
